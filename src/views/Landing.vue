...
<template>
    <div class="flex justify-center items-center min-h-screen">
        <div class="flex flex-col items-center text-center">
            ...
            <div class="flex items-center justify-center w-32 h-32 mb-5 bg-gradient-to-r rounded-full 
            from-[#00264d] via-[#008fd1] to-[#66CC00] rotate-45">
                <img class="w-11/12 h-11/12 rounded-full shadow-lg -rotate-45" src="../assets/jj.jpg" alt="Bonnie image"/>
            </div>
            ...
            <div>
                <span>I am a software engineer, currently driving IT improvements in the energy sector.</span>
            </div>
            ...
            <div class="mt-5">
                ...
                <!--<button
                            ...
                            class="mb-2 mr-2 inline-block rounded px-3 py-2 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
            ...
            <!-- <div class="mt-24">
                <button onclick="window.location.href='#home';" class="px-3 py-2 mb-2 mr-2 text-sm font-medium text-white border-white border rounded-full bg-transparent hover:bg-gradient-to-br hover:from-cyan-600 hover:to-blue-600 hover:border-cyan-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-200 transform transition-transform hover:scale-105">
                    <div class="flex justify-center items-center">
